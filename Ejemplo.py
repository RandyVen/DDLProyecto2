...
def main():
  ...
  temp_node= State(5)
  temp_node.accept = True
  temp_transition = Transition('A', 9)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('B', 9)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('C', 9)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('D', 9)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('E', 9)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('F', 9)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('H', 10)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('0', 5)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('1', 5)
  ...
  temp_node= State(7)
  temp_node.accept = True
  temp_transition = Transition('i', 11)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('f', 2)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('w', 2)
  ...
  temp_transition = Transition('h', 2)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('l', 12)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('e', 2)
  temp_node.transitions.append(temp_transition)
  temp_transition = Transition('a', 2)

...
def create(dfa, extras, name):
    i = 0
    output = open("./scanners/" + name + ".py", "w+", encoding="utf-8")
    ...
    output.write("  last = 0\n")
    if (name == "MyCOCOR"):
        output.write("  data = data.replace('CHR(', 'í')\n")
        output.write("  data = data.replace('(.', 'ó')\n")
        output.write("  data = data.replace('.)', 'ú')\n")
    ...
    output.write("                  if 'í' in valid:\n")
    output.write("                    valid = valid.replace('í', 'CHR(')\n")
    output.write("                  elif 'ó' in valid:\n")
    output.write("                    valid = valid.replace('ó', '(.')\n")
    output.write("                  elif 'ú' in valid:\n")
    output.write("                    valid = valid.replace('ú', '.)')\n")
